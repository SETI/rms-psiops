...
def stdev(
    ...
    *,
    ...
    Parameters:
        ...
        stdtype: The type of the standard deviation estimate:
    ...
    Returns:
        `stdev_image` or (`stdev_image`[, `new_mask`][, `new_weights`]):

        * `stdev_image`: The floating-point standard deviation array. If `image` is a
        ...
        * `new_weights`: The weight array, equal to the sum of the weights of the elements
          that contributed to each pixel in `stdev_image`. By default, this is returned if
