##########################################################################################
# image_ops/imagemodel/arraymodel.py
##########################################################################################
...
class ArrayModel(ImageModel):
    ...
    def __init__(self, array, origin=None, outside=0.):
        ...
        Parameters:
            ...
            origin (array-like, optional): Two floating-point coordinates defining the
                origin coordinates within `array`. If not specified, the midpoint of the
                array is used. Note that integers refer to the corners between pixels and
                half-integers refer to pixel centers. In other words, (0,0) is the lower
                corner of the array and (0.5,0.5) is the center of the first pixel.
            outside (scalar, optional): The value to use outside the array.
        """
